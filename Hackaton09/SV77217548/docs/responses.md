...
```json
{
  ...
  "pageSize": 10,
  "data": [
    { "id": 3, "firstName": "Rony", "lastName": "Chang", "email": "rony.ng.2011@prueba.com", "role": "student" },
    { "id": 4, "firstName": "Olenka", "lastName": "Altamirano", "email": "olenka.altamirano@prueba.com", "role": "student" }
  ]
}
```
  ...
  "data": [
    {
      ...
      "published": true,
      "studentsCount": 2,
      "owner": { "id": 2, "firstName": "Roberto", "lastName": "Pineda", "email": "roberto.pineda@prueba.com" }
    }
  ]
}
```
  ...
  "data": [
    {
      ...
      "courseId": 1,
      "userId": 4,
      "student": { "id": 4, "firstName": "Olenka", "lastName": "Altamirano", "email": "olenka.altamirano@prueba.com" }
    },
    {
      "id": 1,
      "status": "active",
      ...
      "courseId": 1,
      "userId": 3,
      "student": { "id": 3, "firstName": "Rony", "lastName": "Chang", "email": "rony.ng.2011@prueba.com" }
    }
  ]
}
```
