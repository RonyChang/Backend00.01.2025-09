...
module.exports = {
    async up(queryInterface){
        ...
        await queryInterface.bulkDelete('users', {email: ['admin@prueba.com', 'roberto.pineda@prueba.com', 'rony.ng.2011@prueba.com']}, {});
        ...
        await queryInterface.bulkInsert('users', [
            ...
            },
            {
                firstName: 'Roberto',
                lastName: 'Pineda',
                email: 'roberto.pineda@prueba.com',
                passwordHash: bcrypt.hashSync('roberto123', 10),
                role: 'instructor',
                createdAt: now,
                updatedAt: now,
            },
            {
                firstName: 'Rony',
                lastName: 'Chang',
                email: 'rony.ng.2011@prueba.com',
                passwordHash: bcrypt.hashSync('hola123', 10),
                role: 'student',
                createdAt: now,
                updatedAt: now,
            },
        ...
        const [users] = await queryInterface.sequelize.query(
            ...
            {replacements: {emails: ['admin@prueba.com','roberto.pineda@prueba.com','rony.ng.2011@prueba.com']}}
        );
        const getIdByEmail = (email) => users.find((u) => u.email === email)?.id;
        const adminId = getIdByEmail('admin@prueba.com');
        const instructorId = getIdByEmail('roberto.pineda@prueba.com');
        const studentId = getIdByEmail('rony.ng.2011@prueba.com');
